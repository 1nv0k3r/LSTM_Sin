# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 14:19:14 2018
...
HIDDEN_SIZE = 30    #number of hidden cell in LSTM
...
test_X, test_y = generate_data(np.sin(np.linspace(test_start,test_end,TEST_EXAMPLES + TIMESTEPS, dtype=np.float32)))
